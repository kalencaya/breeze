...
public class SystemController {
    ...
    @PreAuthorize("@svs.validate(T(com.liyu.breeze.common.constant.PrivilegeConstants).META_SYSTEM_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(com.liyu.breeze.common.constant.PrivilegeConstants).META_SYSTEM_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(com.liyu.breeze.common.constant.PrivilegeConstants).META_SYSTEM_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(com.liyu.breeze.common.constant.PrivilegeConstants).META_SYSTEM_DELETE)")
