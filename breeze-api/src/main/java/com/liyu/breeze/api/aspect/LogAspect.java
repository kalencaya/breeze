...
import com.liyu.breeze.common.enums.LoginTypeEnum;
...
public class LogAspect {
     ...
     * 配置拦截Logging注解所有方法
     */
    @Pointcut("@annotation(com.liyu.breeze.api.annotation.Logging)")
     ...
     * 登录切面
     */
    @Pointcut("execution(* com.liyu.breeze.api.controller.admin.UserController.login(..))")
     ...
     * 登出切面
     */
    @Pointcut("execution(* com.liyu.breeze.api.controller.admin.UserController.logout(..))")
