 ...
 */
@Configuration
@MapperScan(basePackages = "com.liyu.breeze.dao.mapper", sqlSessionFactoryRef = MasterMybatisConfig.MASTER_SQL_SESSION_FACTORY)
public class MasterMybatisConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory() throws Exception {
        ...
        props.setMapperLocations(new String[]{"classpath*:mapper/*Mapper.xml"});
        MybatisConfiguration configuration = new MybatisConfiguration();
        configuration.setMapUnderscoreToCamelCase(true);
        configuration.setLogImpl(StdOutImpl.class);
        factoryBean.setDataSource(masterDataSource());
        factoryBean.setMapperLocations(props.resolveMapperLocations());
        factoryBean.setTypeAliasesPackage("com.liyu.breeze.dao.entity");
