...
import { DiJob, DiJobParam } from 'src/app/@core/data/studio.data';
...
export class JobComponent implements OnInit {
  ...
  openAddJobDialog(jobType: string) {
    const results = this.modalService.open({
      ...
      data: {
        title: { name: this.translate.instant('studio.job') },
        type: jobType,
        projectId: this.defaultProjectId,
        onClose: (event: any) => {
  ...
  openAddDirDialog(event, node) {
    const results = this.modalService.open({
      ...
      data: {
        title: { name: this.translate.instant('studio.directory') },
        item: node,
        projectId: this.defaultProjectId,
        onClose: (event: any) => {
          results.modalInstance.hide();
